  ...
  'zh-CN': {
    ...
    faqs: [
      ...
      },
      {
        _id: "4",
        question: "支持哪些语言？",
        answer: "我们可以提供日语、英语、中文、越南语、塔加洛语、韩语、葡萄牙语等9种语言的支持。如果您希望用母语得到支持，请告诉我们。",
        order: 4
      },
      {
        _id: "5",
        question: "申请需要多长时间？",
        answer: "根据申请的种类和内容而异，但通常从文件准备到申请完成需要1〜3个月左右。对于紧急案件，我们会尽快处理。详细时间表会在初次咨询时说明。",
        order: 5
      },
      {
        _id: "6",
        question: "是否可以在周末和节假日办理？",
        answer: "周六仅上午营业。周日和节假日是定期休息日，但提前预约的话也可能对应。工作日难以到访事务所的客户，请咨询。",
        order: 6
      },
      {
        _id: "7",
        question: "服务区域到哪里？",
        answer: "主要服务东京都、千叶县、埼玉县、神奈川县，但通过在线咨询也接受全国各地的委托。远方的客户也请随时咨询。",
        order: 7
      },
      {
        _id: "8",
        question: "有什么付款方式？",
        answer: "支持银行转账、信用卡、现金付款。也接受分期付款的咨询，请随时提出。",
        order: 8
      }
    ]
  },
  'zh-TW': {
    ...
    faqs: [
      ...
      },
      {
        _id: "4",
        question: "支援哪些語言？",
        answer: "我們可以提供日語、英語、中文、越南語、他加祿語、韓語、葡萄牙語等9種語言的支援。如果您希望用母語得到支援，請告訴我們。",
        order: 4
      },
      {
        _id: "5",
        question: "申請需要多長時間？",
        answer: "根據申請的種類和內容而異，但通常從文件準備到申請完成需要1〜3個月左右。對於緊急案件，我們會盡快處理。詳細時間表會在初次諮詢時說明。",
        order: 5
      },
      {
        _id: "6",
        question: "是否可以在週末和節假日辦理？",
        answer: "週六僅上午營業。週日和節假日是定期休息日，但提前預約的話也可能對應。工作日難以到訪事務所的客戶，請諮詢。",
        order: 6
      },
      {
        _id: "7",
        question: "服務區域到哪裡？",
        answer: "主要服務東京都、千葉縣、埼玉縣、神奈川縣，但透過線上諮詢也接受全國各地的委託。遠方的客戶也請隨時諮詢。",
        order: 7
      },
      {
        _id: "8",
        question: "有什麼付款方式？",
        answer: "支援銀行轉帳、信用卡、現金付款。也接受分期付款的諮詢，請隨時提出。",
        order: 8
      }
    ]
  },
