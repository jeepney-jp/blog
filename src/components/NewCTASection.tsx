...
const content = {
  ja: {
    ...
    point2Title: '業界最安水準',
    point2Desc: '平均相場より最大30%安い',
    point3Title: '多言語対応',
    point3Desc: '9ヶ国語でサポート',
    ctaButton: '無料相談を予約する',
    phoneLabel: 'お電話でのご相談',
    hours: '平日 9:00〜18:00',
  },
  en: {
    ...
    point2Title: 'Industry-lowest Pricing',
    point2Desc: 'Up to 30% cheaper than average',
    point3Title: 'Multilingual Support',
    point3Desc: 'Support in 9 Languages',
  ...
  vi: {
    ...
    point2Title: 'Giá thấp nhất thị trường',
    point2Desc: 'Rẻ hơn tới 30% so với giá trung bình',
    point3Title: 'Hỗ trợ đa ngôn ngữ',
    point3Desc: 'Hỗ trợ 9 thứ tiếng',
