      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {serviceCategories.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {serviceCategories.map((category) => (
                <Link
                  ...
                  className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md hover:scale-105 hover:bg-blue-50/30 transition-all duration-300 text-center block"
                >
                  <div className="mb-4">
                    {category.iconUrl ? (
                      <Image
            ...
            {/* 外国人関連業務 */}
            <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md hover:scale-105 hover:bg-blue-50/30 transition-all duration-300 text-center">
              <div className="mb-4">
                <Image
