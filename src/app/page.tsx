        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">相続・遺言</h3>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">会社設立・法人</h3>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">契約書作成</h3>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900">各種申請業務</h3>
            </div>
